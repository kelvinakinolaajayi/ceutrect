...
<?php
  ...
  "WHEN ministryProgram_attendance.id IS NOT NULL THEN " .
  "'present' " .
  "ELSE " .
  "'absent' " .
  ...
  "LEFT JOIN " .
  "heroku_cac12764d97fd49.ministryProgram_attendance " .
  "on brethren.BrethrenID = ministryProgram_attendance.BrethrenID AND ministryProgram_attendance.DatePresent = '" . $celldate . "' " .
