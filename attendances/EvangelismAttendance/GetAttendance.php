...
<?php
  ...
  "WHEN evangelism_attendance.id IS NOT NULL THEN " .
  "'present' " .
  "ELSE " .
  "'absent' " .
  ...
  "LEFT JOIN " .
  "heroku_cac12764d97fd49.evangelism_attendance " .
  "on brethren.BrethrenID = evangelism_attendance.BrethrenID AND evangelism_attendance.DatePresent = '" . $celldate . "' " .
