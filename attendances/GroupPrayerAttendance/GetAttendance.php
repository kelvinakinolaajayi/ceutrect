...
<?php
  ...
  "WHEN groupPrayers_attendance.id IS NOT NULL THEN " .
  "'present' " .
  "ELSE " .
  "'absent' " .
  ...
  "LEFT JOIN " .
  "heroku_cac12764d97fd49.groupPrayers_attendance " .
  "on brethren.BrethrenID = groupPrayers_attendance.BrethrenID AND groupPrayers_attendance.DatePresent = '" . $celldate . "' " .
