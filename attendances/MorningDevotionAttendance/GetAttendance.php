...
<?php
  ...
  "WHEN morningDevotion_attendance.id IS NOT NULL THEN " .
  "'present' " .
  "ELSE " .
  "'absent' " .
  ...
  "LEFT JOIN " .
  "heroku_cac12764d97fd49.morningDevotion_attendance " .
  "on brethren.BrethrenID = morningDevotion_attendance.BrethrenID AND morningDevotion_attendance.DatePresent = '" . $celldate . "' " .
