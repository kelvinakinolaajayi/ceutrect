...
<?php
  ...
  "WHEN church_attendance.id IS NOT NULL THEN " .
  "'present' " .
  "ELSE " .
  "'absent' " .
  ...
  "LEFT JOIN " .
  "heroku_cac12764d97fd49.church_attendance " .
  "on brethren.BrethrenID = church_attendance.BrethrenID AND church_attendance  .DatePresent = '" . $celldate . "' " .
