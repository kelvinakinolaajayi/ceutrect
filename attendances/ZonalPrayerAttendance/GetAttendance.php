...
<?php
  ...
  "WHEN zonalPrayer_attendance.id IS NOT NULL THEN " .
  "'present' " .
  "ELSE " .
  "'absent' " .
  ...
  "LEFT JOIN " .
  "heroku_cac12764d97fd49.zonalPrayer_attendance " .
  "on brethren.BrethrenID = zonalPrayer_attendance.BrethrenID AND zonalPrayer_attendance.DatePresent = '" . $celldate . "' " .
