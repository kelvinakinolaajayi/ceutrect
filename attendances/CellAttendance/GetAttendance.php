...
<?php
  ...
  "WHEN cell_attendance.id IS NOT NULL THEN " .
  "'present' " .
  "ELSE " .
  "'absent' " .
  ...
  "LEFT JOIN " .
  "heroku_cac12764d97fd49.cell_attendance " .
  "on brethren.BrethrenID = cell_attendance.BrethrenID AND cell_attendance.DatePresent = '" . $celldate . "' " .
