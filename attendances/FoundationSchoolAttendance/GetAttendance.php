...
<?php
  ...
  "WHEN foundationSchool_attendance.id IS NOT NULL THEN " .
  "'present' " .
  "ELSE " .
  "'absent' " .
  ...
  "LEFT JOIN " .
  "heroku_cac12764d97fd49.foundationSchool_attendance " .
  "on brethren.BrethrenID = foundationSchool_attendance.BrethrenID AND foundationSchool_attendance.DatePresent = '" . $celldate . "' " .
