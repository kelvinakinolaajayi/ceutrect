...
<html lang="en">
  ...
  <body>
    <div class="container">
      <div class="left">
        <ul>
          <li><a href="#"><img class="nav-images" src="images/icons8-monitor-50.png" alt="monitor"></a></li>
          <li><a href="#"><img class="nav-images" src="images/icons8-users-60.png" alt="users"></a></li>
          <li><a href="#"><img class="nav-images" src="images/icons8-graduation-cap-60.png" alt="graudation"></a></li>
          <li><a href="#"><img class="nav-images" src="images/icons8-handshake-60.png" alt="handshake"></a></li>
          <li><a href="#"><img class="nav-images" src="images/icons8-gear-64.png" alt="gear"></a></li>
        </ul>
      </div>
      <div class="center">
  ...
  <script>
            function addTextBox() {
                var form = document.getElementById("FirstTimers");
                var textBox = document.createElement("input");
                textBox.type = "text";
                textBox.name = 'firstTimers[]'; // Use an array to allow multiple textboxes
